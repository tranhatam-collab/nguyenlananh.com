...
Branch: main
Commit: c5c8231 (HEAD -> main)
Commit message: fix(admin-email-test): support x-admin-key auth for easier Resend verification
Working tree: clean
...
- Production deployment preview: https://1183f996.nguyenlananh-com-63s.pages.dev (or latest Pages deployment; use https://www.nguyenlananh.com/ as canonical)
- Last verified commit: c5c8231
