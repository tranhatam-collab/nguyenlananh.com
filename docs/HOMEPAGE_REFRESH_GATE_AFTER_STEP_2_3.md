...
Homepage refresh is allowed only after every condition below is true.

| Gate | Status | Evidence |
|---|---|---|
| 10 public pillars live | done | `docs/reports/TEAM_2_PILLAR_CONTENT_REPORT_2026-04-29.md` |
...
1. Public writings as the trust layer.
2. Free join as the first action.
3. Core member journey as the first paid path.
4. Deep programs as structured practice, not extra reading.
5. Pro tracks as 30/60/90-day implementation paths.
6. Creator/collaborator as an internal quality path, not a public payout promise.
7. Main CTA: start with a writing or join free, not immediate pressure-buy.

Homepage refresh must not include:

- exaggerated transformation claims
- public commission/revenue language
