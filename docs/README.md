...
16. `MANUAL_DEPLOY_RUNBOOK.md`
17. `ARTICLE_IMAGE_SEO_SYSTEM.md`
18. `FOUNDATION_ARTICLE_IMAGE_PROMPTS.md`
19. `MEMBERSHIP_TOPIC_SOUND_SELF_PRACTICE_MASTER_PLAN.md`
20. `PUBLIC_ARTICLE_SOUND_SELF_PRACTICE_FULL_COPY.md`
21. `MEMBERS_DEEP_SOUND_SELF_PRACTICE_FULL_COPY.md`
22. `SOUND_SELF_PRACTICE_FINAL_DEV_HANDOFF.md`
23. `contracts/paypal-membership-openapi.yaml`
24. `contracts/paypal-event-email-map.json`
25. `contracts/paypal-membership-implementation-notes.md`
26. `contracts/paypal-membership-schema-patch.sql`
27. `contracts/paypal-api-examples.http`
28. `contracts/paypal-backend-test-matrix.md`
29. `contracts/paypal-backend-smoke.sh`
30. `contracts/reference-backend/README.md`
31. `contracts/reference-backend/event-router-skeleton.mjs`
32. `contracts/reference-backend/service-skeleton.mjs`
