...
ƯU TIÊN SỐ 1 — PRODUCTION: Trước khi vào backlog T*, đọc docs/plans/KIMI_PROD_FINISH.md và thực hiện §B (promote branch -> main để fix production stale, đã verify an toàn trên preview build) rồi §C (verify smoke-production all PASS). Sau đó mới chạy backlog T3–T10 và P3.

BẮT ĐẦU NGAY: đọc master plan + KIMI_PROD_FINISH.md + PROGRESS.md, làm P0 production trước, rồi loop backlog. Báo cáo liên tục trong PROGRESS.md. ĐỪNG hỏi gì — chỉ làm.
