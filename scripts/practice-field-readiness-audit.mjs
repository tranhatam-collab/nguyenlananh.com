...
const checks = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /id="reflection-d1-admin-key"/,
      /id="reflection-d1-handoff-filter"/,
      /id="reflection-d1-priority-filter"/,
      /id="reflection-d1-limit"/,
      /id="reflection-evidence-load-d1"/,
      /id="reflection-evidence-d1-status"/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /id="member-snapshot-queue-clear-filters"/,
      /id="member-snapshot-queue-active-filters"/,
      ...
      /id="member-snapshot-queue-admin-key"/,
      /id="member-snapshot-queue-pull-d1"/,
      /id="member-snapshot-queue-replace-from-d1"/,
      /id="member-snapshot-queue-push-d1"/,
      /id="member-snapshot-queue-clear-d1"/,
      /id="member-snapshot-queue-sync-status"/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /id="pilot-d1-admin-key"/,
      /id="pilot-d1-handoff-filter"/,
      /id="pilot-d1-priority-filter"/,
      /id="pilot-d1-limit"/,
      /id="pilot-evidence-load-d1"/,
      /id="pilot-evidence-d1-status"/,
      /intake queue packet/i,
      /Day 1/,
      /Day 3/,
      /Day 7/
  ...
  },
  {
    ...
    patterns: [
      ...
      /member-snapshot-queue-admin-key/,
      /member-snapshot-queue-pull-d1/,
      /member-snapshot-queue-replace-from-d1/,
      /member-snapshot-queue-push-d1/,
      /member-snapshot-queue-clear-d1/,
      /member-snapshot-queue-sync-status/,
      ...
      /sourcePath/,
      /data-reopen-restored-source/,
      /Open .* again with this filtered queue|Mở lại .* với phần đang lọc này/,
      ...
      /reflection-d1-admin-key/,
      /reflection-d1-handoff-filter/,
      /reflection-d1-priority-filter/,
      /reflection-d1-limit/,
      /reflection-evidence-load-d1/,
      /reflection-evidence-d1-status/,
      ...
      /pilot-d1-admin-key/,
      /pilot-d1-handoff-filter/,
      /pilot-d1-priority-filter/,
      /pilot-d1-limit/,
      /pilot-evidence-load-d1/,
      /pilot-evidence-d1-status/,
      /sanitizeQueueLimit/,
