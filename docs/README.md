...
56. `NGUYENLANANH_90_DAY_TO_3_YEAR_AUTOMATION_MASTER_PLAN_2026.md`
57. `NGUYENLANANH_CONTENT_SYSTEM_99_DAYS_2026-04-17.md`
58. `NGUYENLANANH_HOMEPAGE_BRAND_MEMBERS_MASTERPLAN_2026-04.md`
59. `NGUYENLANANH_LAUNCH_CONTENT_PACK_2026-04-17.md`
60. `NGUYENLANANH_DEV_MASTERPLAN_UNIFIED_2026-04.md`
61. `SYNC_UPDATE_PLAN_2026-04-25.md`
...
- `ADMIN_OPERATION_GUIDE.md`: hướng dẫn vận hành admin: login, CRUD member, content account, manual override.
- `BILINGUAL_LANGUAGE_CODEX.md`: bộ quy chuẩn ngôn ngữ song ngữ VI/EN, tone, cách dịch và điều cấm.
- `ARTICLE_VISUAL_UPGRADE_2026-04-21.md`: kế hoạch nâng cấp hình ảnh minh họa bài viết theo image SEO system.
- `ARTICLE_IMAGE_LOCAL_MAP_2026-04-21.md`: mapping slug bài viết → file SVG hero local để build không phụ thuộc CDN ngoài.
- `PAYMENT_GATEWAY_LIVE_RUNBOOK.md`: runbook live PayPal production: env check, test order, webhook verify.
- `NGUYENLANANH_90_DAY_TO_3_YEAR_AUTOMATION_MASTER_PLAN_2026.md`: roadmap tự động hóa 90 ngày → 3 năm gồm email, content, community, analytics.
- `NGUYENLANANH_CONTENT_SYSTEM_99_DAYS_2026-04-17.md`: editorial calendar 99 ngày theo giọng viết locked, dùng cho AI generation và lịch đăng.
- `NGUYENLANANH_HOMEPAGE_BRAND_MEMBERS_MASTERPLAN_2026-04.md`: masterplan kết hợp homepage + membership cho giai đoạn chuyển đổi tháng 4.
- `NGUYENLANANH_LAUNCH_CONTENT_PACK_2026-04-17.md`: launch pack source cho 10 bài nội tâm bilingual, dùng bởi `scripts/build-launch-articles.mjs`.
- `NGUYENLANANH_DEV_MASTERPLAN_UNIFIED_2026-04.md`: master plan hợp nhất (brand, homepage, menu, membership, admin, creator layer, sprint plan).
- `SYNC_UPDATE_PLAN_2026-04-25.md`: kế hoạch đồng bộ hóa toàn bộ thay đổi vừa thêm vào working tree, phân lane commit + 8 quality gate trước deploy.
